...
if ( ! function_exists( 'national_supply_chain_day_follow_us_shortcode' ) ) {
  function national_supply_chain_day_follow_us_shortcode( $atts, $content = null ) {
    $defaults = array(
      'facebook'  => 'https://www.facebook.com/SupplyChainNow',
      'instagram' => 'https://www.instagram.com/supplychainnow/',
      'linkedin'  => 'https://www.linkedin.com/company/supply-chain-now/',
      'twitter'   => 'https://x.com/_supplychainnow',
      'youtube'   => 'https://www.youtube.com/channel/UCuqKDp8uxinIM8ORIOLr0qw',
    );
    ...
    <div class="flex items-center gap-16 xs:flex-col flex-child-static">
      ...
      <div class="flex items-center gap-12">
        ...
        <a href="<?= $atts['twitter']; ?>" class="w-inline-block" target="_blank" rel="noopener noreferrer">
          <div class="flex items-center text-secondary hover:text-primary w-embed">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
add_action( 'init', function () {
  add_shortcode( 'national_supply_chain_day_follow_us',
    'national_supply_chain_day_follow_us_shortcode' );
} );