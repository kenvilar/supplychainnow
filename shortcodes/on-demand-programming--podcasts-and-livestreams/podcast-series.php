...
if ( ! function_exists( 'on_demand_podcasts_and_livestreams_podcast_series_shortcode' ) ) {
	function on_demand_podcasts_and_livestreams_podcast_series_shortcode() {
		$pageID  = get_the_ID();
...
add_action( 'init', function () {
	add_shortcode( 'on_demand_podcasts_and_livestreams_podcast_series',
		'on_demand_podcasts_and_livestreams_podcast_series_shortcode' );
} );