...
if ( ! function_exists( 'on_demand_podcasts_and_livestreams_recent_episodes_shortcode' ) ) {
	function on_demand_podcasts_and_livestreams_recent_episodes_shortcode() {
		ob_start();
		?>
...
add_action( 'init', function () {
	add_shortcode( 'on_demand_podcasts_and_livestreams_recent_episodes',
		'on_demand_podcasts_and_livestreams_recent_episodes_shortcode' );
} );