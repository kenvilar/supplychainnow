...
if ( ! function_exists( 'resource_hub_recent_guides_shortcode' ) ) {
	function resource_hub_recent_guides_shortcode( $atts, $content = null ) {
...
add_action( 'init', function () {
	add_shortcode( 'resource_hub_recent_guides', 'resource_hub_recent_guides_shortcode' );
} );