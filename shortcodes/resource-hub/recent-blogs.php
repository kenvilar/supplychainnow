...
if ( ! function_exists( 'resource_hub_recent_blogs_shortcode' ) ) {
	function resource_hub_recent_blogs_shortcode( $atts, $content = null ) {
...
add_action( 'init', function () {
	add_shortcode( 'resource_hub_recent_blogs', 'resource_hub_recent_blogs_shortcode' );
} );