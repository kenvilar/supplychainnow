...
if ( ! function_exists( 'resource_hub_recent_articles_shortcode' ) ) {
	function resource_hub_recent_articles_shortcode( $atts, $content = null ) {
...
add_action( 'init', function () {
	add_shortcode( 'resource_hub_recent_articles', 'resource_hub_recent_articles_shortcode' );
} );