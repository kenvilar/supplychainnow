...
if ( ! function_exists( 'resource_hub_recent_ebooks_shortcode' ) ) {
  function resource_hub_recent_ebooks_shortcode( $atts, $content = null ) {
...
add_action( 'init', function () {
  add_shortcode( 'resource_hub_recent_ebooks', 'resource_hub_recent_ebooks_shortcode' );
} );