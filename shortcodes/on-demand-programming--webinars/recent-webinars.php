...
if ( ! function_exists( 'on_demand_recent_webinars_shortcode' ) ) {
	function on_demand_recent_webinars_shortcode() {
		ob_start();
		?>
...
add_action( 'init', function () {
	add_shortcode( 'on_demand_recent_webinars', 'on_demand_recent_webinars_shortcode' );
} );