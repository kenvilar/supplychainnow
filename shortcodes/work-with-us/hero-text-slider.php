...
if ( ! function_exists( 'work_with_us_hero_text_slider_shortcode' ) ) {
	function work_with_us_hero_text_slider_shortcode( $atts, $content = null ) {
		$pageID  = get_the_ID();
                ...
                <div class="flex items-center gap-20 justify-center xs:flex-col">
                  <div class="flex w-embed">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" width="27" height="28" viewBox="0 0 27 28"
                        ...
                        <path d="M21.4524 0V24.9999" stroke="#FFAB56" stroke-width="2"
...
add_action( 'init', function () {
	add_shortcode( 'work_with_us_hero_text_slider', 'work_with_us_hero_text_slider_shortcode' );
} );