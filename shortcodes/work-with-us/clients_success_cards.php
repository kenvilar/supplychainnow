...
if ( ! function_exists( 'work_with_us_clients_success_cards_shortcode' ) ) {
	function work_with_us_clients_success_cards_shortcode( $atts, $content = null ) {
		$pageID  = get_the_ID();
...
add_action( 'init', function () {
	add_shortcode( 'work_with_us_clients_success_cards', 'work_with_us_clients_success_cards_shortcode' );
} );