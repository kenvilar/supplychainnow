...
if ( ! function_exists( 'about_awards_and_recognitions_shortcode' ) ) {
	function about_awards_and_recognitions_shortcode() {
		$pageID  = get_the_ID();
...
add_action( 'init', function () {
	add_shortcode( 'about_awards_and_recognitions', 'about_awards_and_recognitions_shortcode' );
} );