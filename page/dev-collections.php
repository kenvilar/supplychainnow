							...
							<div class="w-full h-full">
									...
									<div class="overflow-hidden rounded-12 relative h-344 bg-cargogrey">
										...
										<div class="absolute absolute--tl p-24 flex items-center justify-center">
											<div class="relative rounded-full overflow-hidden py-4 px-8">
												<div class="relative font-semibold uppercase text-2xs text--white lh-full z-10">This is some
								...
								<div class="mb-12">
									<div class="flex items-center gap-32 sm:flex-wrap sm:gap-8">
										...
										<div class="flex items-center gap-8">
											<div class="font-family-secondary font-light text-xs">April 11, 2025</div>
											<div>•</div>
											<div class="font-family-secondary font-light text-xs">6 min 25 sec</div>
										</div>
									</div>
								</div>
							...
							<div class="relative flex flex-col gap-20 h-full">
								<div class="w-full h-full">
									...
									<div class="mb-12">
										<div class="flex items-center gap-32 sm:flex-wrap sm:gap-8">
											<div class="flex items-center gap-8">
												<div class="font-family-secondary text-xs">test</div>
											</div>
											<div class="flex items-center gap-8">
												<div class="font-family-secondary font-light text-xs">April 11, 2025</div>
												<div>•</div>
								...
								<div class="w-full">
									<div class="rt--plain truncate-2-lines-fallback w-richtext">
