<?php
/*
 * Template Name: Programs/Brands v2
 */
...
<div class="page-wrapper">
	<div class="main-wrapper">
		<section class="section bg-cargogrey text-white rounded-b-100">
			<div class="site-padding sm:py-60 pt-200 pb-116 relative z-10 pb-200">
				<div class="w-layout-blockcontainer pt-20 w-container text-center max-w-960">
					...
					<div>
						<p class="font-family-alternate font-medium text-xl tracking-[2.4px] capitalize">Explore the voice of supply
							chain and find what speaks to you
						</p>
					</div>
				</div>
			</div>
			<div class="absolute absolute--full w-full h-full">
				<img src="https://cdn.prod.website-files.com/6858d0b082937600c76df99a/6889bd5e4478496d863cee33_hero-brands.avif"
							...
							<div class="w-dyn-list">
								<div role="list" class="grid grid-cols-2 gap-36 sm:grid-cols-1 w-dyn-items">
									<div role="listitem" class="w-dyn-item">
										<a href="/program/supply-chain-now"
					...
					<div class="mb-76">
						<div class="w-dyn-list">
							<div role="list" class="grid grid-cols-3 gap-32 md:grid-cols-2 sm:grid-cols-1 w-dyn-items">
								...
								<div role="listitem" class="w-dyn-item">
									<a href="/program/digital-transformers"
									   class="w-full overflow-hidden rounded-24 hover-shadow2 w-inline-block">
										<div class="h-396 sm:h-200">
											<img
												...
												loading="lazy" alt="Digital Transformers" class="image">
										</div>
									</a>
								</div>
								<div role="listitem" class="w-dyn-item">
									<a href="/program/veteran-voices"
									   class="w-full overflow-hidden rounded-24 hover-shadow2 w-inline-block">
										<div class="h-396 sm:h-200">
											<img
												src="https://cdn.prod.website-files.com/686225582293e0967d2b9375/6889b65154ff2052b5cb113a_program-veteran%20voices.avif"
												loading="lazy" alt="Veteran Voices" class="image">
										</div>
									</a>
								</div>
								<div role="listitem" class="w-dyn-item">
									<a href="/program/business-history"
									   class="w-full overflow-hidden rounded-24 hover-shadow2 w-inline-block">
										<div class="h-396 sm:h-200">
											<img
								...
								<div role="listitem" class="w-dyn-item">
									<a href="/program/tektok" class="w-full overflow-hidden rounded-24 hover-shadow2 w-inline-block">
										<div class="h-396 sm:h-200">
											<img
