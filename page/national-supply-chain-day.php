...
<div class="page-wrapper">
	<div class="main-wrapper">
		...
		<section class="section sm:text-center">
			<div class="site-padding sm:py-60 py-92">
				<div class="w-layout-blockcontainer max-w-708 w-container">
					...
					<div class="mb-48">
						<div class="w-layout-blockcontainer max-w-644 w-container">
							<p class="tracking-[1.6px]">National Supply Chain Day®, is a celebration and a spotlight on the industry
					...
					<div class="w-layout-blockcontainer max-w-424 sm:max-w-full w-container">
						<div class="flex items-center justify-between gap-20 sm:flex-col">
							<div class="flex">
								<a
									href="https://linktr.ee/Supplychainnow?fbclid=PAZXh0bgNhZW0CMTEAAaeUwT0HgleEdMIgdSFAMNFw5XHXweqOR0cBt5kQKeNX1PVUZDW1gomBKleWzw_aem_sF5GDmuaeT-qg4pzKobvwA"
		...
		<section class="section">
			<div class="site-padding sm:py-60 py-92">
				<div class="w-layout-blockcontainer max-w-832 w-container">
					<div class="mb-52">
						<h2 class="text-center">Celebrating National Supply Chain Day℠</h2>
					</div>
					<div class="mb-52">
						<div class="w-layout-blockcontainer max-w-828 w-container">
							<div class="overflow-hidden rounded-24">
								<img
									src="https://cdn.prod.website-files.com/6858d0b082937600c76df99a/6875170fded5985cf1e11603_celebrating%20national%20supply%20chain%20day.avif"
					...
					<div class="mb-52">
						<div class="w-layout-blockcontainer max-w-676 w-container">
							<p class="text-center tracking-[1.6px]">Join us as Scott W. Luton and National Supply Chain Day® founder,
								Mary
					...
					<div class="w-layout-blockcontainer max-w-1248 w-container">
						<div class="flex items-center justify-between gap-20 sm:flex-col">
							<div class="max-w-724 w-full md:max-w-full sm:text-center">
								<div class="mb-16">
									<h2>2026 Sponsorships Available</h2>
								</div>
								<div class="mb-40">
									<div class="font-semibold text-lg text-secondary">Are you interested in sponsoring National Supply
										Chain Day® in 2026?
									</div>
								</div>
								<div class="mb-40">
									<div class="max-w-584 w-full md:max-w-full">
										<p class="tracking-[1.6px]">Reach out to Mary Kate Love at nscd@supplychainnow.com
											<br>
											<br>
								...
								<div class="grid grid-cols-2 gap-16 sm:grid-cols-1">
									<div class="card">
										<div class="flex items-center justify-center h-92">
											<img
												src="https://cdn.prod.website-files.com/6858d0b082937600c76df99a/6875b1d2675edbad1976693f_charlie%20pesti.svg"
												loading="lazy" alt="">
										</div>
									</div>
									<div class="card">
										<div class="flex items-center justify-center h-92">
											<img
												src="https://cdn.prod.website-files.com/6858d0b082937600c76df99a/6875b1d2a7c637eaa2e16961_illinois.svg"
												loading="lazy" alt="">
										</div>
									</div>
									<div class="card">
										<div class="flex items-center justify-center h-92">
											<img
												src="https://cdn.prod.website-files.com/6858d0b082937600c76df99a/6875b1d2f25e85a49c686b23_california%20state%20university%20long%20beach.svg"
												loading="lazy" alt="">
										</div>
									</div>
									<div class="card">
										<div class="flex items-center justify-center h-92">
											<img
												src="https://cdn.prod.website-files.com/6858d0b082937600c76df99a/6875b1d2cd76cf413e3d85fe_university%20of%20arkansas.svg"
												loading="lazy" alt="">
										</div>
									</div>
									<div class="card">
										<div class="flex items-center justify-center h-92">
											<img
												src="https://cdn.prod.website-files.com/6858d0b082937600c76df99a/6875b1d2cd76cf413e3d85db_the%20university%20of%20texas%20at%20dallas.svg"
												loading="lazy" alt="">
										</div>
									</div>
									<div class="card">
										<div class="flex items-center justify-center h-92">
											<img
												src="https://cdn.prod.website-files.com/6858d0b082937600c76df99a/6875b1d27389043c96afeac9_vector%20global%20logistics.svg"
												loading="lazy" alt="">
										</div>
									</div>
								</div>
		...
		<div class="rounded-t-100 overflow-hidden relative">
			<section class="section text-white relative z-10">
				<div class="site-padding sm:py-60 py-84">
					<div class="w-layout-blockcontainer w-container max-w-1250">
						<div class="mb-52">
							<div class="mb-20">
								<h2 class="text-center">Check Out Our 2025 Livestream</h2>
							</div>
							<div
								class="w-layout-blockcontainer max-w-136 w-full h-1 relative bg-cargogrey/25 w-container bg-white/25">
								<div class="absolute absolute--r flex items-center pr-32">
									<div blinking-dot="" class="size-8 rounded-8 bg-primary"></div>
								</div>
							</div>
						</div>
						<div class="overflow-hidden rounded-24 bg-brightgray">
							<iframe width="100%" height="528" src="https://www.youtube.com/embed/eyzGyoHDNGg"
							        title="Celebrating National Supply Chain Day" frameborder="0"
			...
			<div class="absolute absolute--full w-full h-full gradient7"></div>
		</div>
	</div>
</div>
