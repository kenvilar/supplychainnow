	...
	<div class="main-wrapper">
		<section class="section bg-cargogrey text-white rounded-b-100">
			...
			<div class="absolute absolute--full w-full h-full">
				<img src="https://cdn.prod.website-files.com/6858d0b082937600c76df99a/6891a7c39d220f41bb9bee98_hero--blogs.avif"
				     loading="lazy" alt="hero--blogs" class="image opacity-10">
			</div>
		</section>
			...
			<div class="site-padding py-0">
				<div class="w-layout-blockcontainer max-w-full w-container">
					<div class="flex justify-center items-center sm:flex-col">
						...
						<a href="/blog" aria-current="page" class="resource-hub-link w-inline-block w--current">
							<div>Blog</div>
						</a>
						...
						<div role="list" class="flex justify-center gap-28 sm:flex-col w-dyn-items">
							<div role="listitem" class="w-full group w-dyn-item">
								<div class="flex flex-col gap-20 h-full">
									...
									<div class="w-full">
										<div class="rt--plain truncate-2-lines-fallback w-richtext">What is a Content Strategy?A content
											strategy outlines how you will create, publish, and manage content. It is essential for achieving
											yo...
										</div>
									</div>
								</div>
							...
							<div role="listitem" class="w-full group w-dyn-item">
								<div class="flex flex-col gap-20 h-full">
									...
									<div class="w-full">
										<div class="rt--plain truncate-2-lines-fallback w-richtext">SEO FundamentalsYour CMS can
											significantly impact your website's SEO. Choosing the right platform is essential for optimizing
											your co...
										</div>
									</div>
								</div>
												...
												<div class="w-full h-full">
													<div class="mb-28">
														<div class="overflow-hidden rounded-12 relative h-220 bg-cargogrey">
															...
															<div fs-list-nest="blogs-tags" fs-list-element="nest-target"></div>
														</div>
													</div>
													<div class="mb-12">
														<div class="flex items-center gap-32 sm:flex-wrap sm:gap-8">
