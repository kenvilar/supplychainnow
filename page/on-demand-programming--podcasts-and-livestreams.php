	...
	<div class="main-wrapper">
		<section class="section bg-cargogrey text-white rounded-b-100">
			...
			<div class="absolute absolute--full w-full h-full">
				<img
					src="https://cdn.prod.website-files.com/6858d0b082937600c76df99a/688ddc83db1c7699d7b1a40a_hero-on-deman%20programmin%20podcasts%20and%20livestreams.avif"
				...
				<div class="w-layout-blockcontainer max-w-full w-container">
					<div class="flex justify-center xs:flex-col">
						<a href="/on-demand-programming"
						   class="on-demand-programming-link w-inline-block">
							<div>All Content</div>
						</a>
						<a href="/on-demand-programming/podcasts-and-livestreams" aria-current="page"
		...
		<section class="section">
			<div class="site-padding sm:py-60 py-60 pb-92">
				<div class="w-layout-blockcontainer max-w-1372 relative w-container">
					<div class="mb-44">
						<div class="mb-20">
							<h2 class="text-center">Featured Podcast Episodes</h2>
						</div>
							...
							<div class="w-dyn-list">
								<div role="list" class="flex justify-center gap-28 sm:flex-col w-dyn-items">
									<div role="listitem" class="w-full group w-dyn-item">
										<a href="#"
										   class="flex flex-col gap-20 h-full w-inline-block">
										   ...
										   class="flex flex-col gap-20 h-full w-inline-block">
											<div class="w-full h-full">
												<div class="mb-28">
													<div class="overflow-hidden rounded-12 relative h-344 bg-cargogrey">
														<img
															src="https://cdn.prod.website-files.com/686225582293e0967d2b9375/68937a153918d6a1775ef69c_image7.jpeg"
															loading="lazy" alt="Career change podcast episode" class="image relative opacity-40">
														<div class="absolute absolute--tl p-24">
															<div style="background-color:#4e88b6" class="rounded-full text-white py-4 px-8">
												...
												<h3 class="font-semibold">Navigating Career Changes</h3>
											</div>
											<div class="w-full">
												<p>We discuss strategies for managing career transitions.</p>
											</div>
										</a>
									</div>
								</div>
								...
								<div slider-1=""
									...
									<div class="splide__track w-dyn-list splide__track--loop splide__track--ltr splide__track--draggable"
										...
										<div role="presentation" class="splide__list w-dyn-items" id="splide01-list"
										     style="transform: translateX(-2995.89px);">
											<div role="group" class="splide__slide group w-dyn-item splide__slide--clone"
											     id="splide01-clone01" aria-roledescription="slide" aria-label="3 of 8"
											     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);" aria-hidden="true">
												<a href="#"
												   class="w-full flex flex-col gap-20 h-full w-inline-block"
												   tabindex="-1">
													<div class="w-full h-full">
														<div class="mb-28">
															<div class="overflow-hidden rounded-12 relative h-220 bg-cargogrey">
																...
																<div class="absolute absolute--tl p-24">
																	<div class="rounded-full text-white py-4 px-8 text-center relative overflow-hidden">
																		<div class="font-semibold text-2xs uppercase relative z-1 w-condition-invisible">
																			User Experience
																		</div>
																		<div
																			class="font-semibold text-2xs uppercase relative z-1 text-white w-condition-invisible">
																			User Experience
																		</div>
																		<div
																			class="absolute absolute--full w-full h-full bg-primary w-condition-invisible"></div>
																		<div
																			class="absolute absolute--full w-full h-full bg-tertiary w-condition-invisible"></div>
																	</div>
																</div>
																<div
																	class="absolute absolute--full flex items-center justify-center translate-y-220 group-hover:translate-y-0 transition-all duration-500">
											...
											<div role="group" class="splide__slide group w-dyn-item splide__slide--clone"
											     id="splide01-clone02" aria-roledescription="slide" aria-label="4 of 8"
											     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);" aria-hidden="true">
												<a href="#"
												   class="w-full flex flex-col gap-20 h-full w-inline-block"
												   tabindex="-1">
													<div class="w-full h-full">
														<div class="mb-28">
															<div class="overflow-hidden rounded-12 relative h-220 bg-cargogrey">
																<img
																	src="https://cdn.prod.website-files.com/686225582293e0967d2b9375/68937ce4e7ccfa3fb32d1af5_image17.jpeg"
																	loading="lazy" alt="Happiness podcast episode" class="image relative opacity-40">
																<div class="absolute absolute--tl p-24">
																	<div class="rounded-full text-white py-4 px-8 text-center relative overflow-hidden">
																		<div class="font-semibold text-2xs uppercase relative z-1 w-condition-invisible">
														...
														<div class="mb-12">
															<div class="flex items-center gap-32 sm:flex-wrap sm:gap-8">
																...
																<div class="flex items-center gap-8">
																	...
																	<div>•</div>
																	<div class="font-family-secondary font-light text-xs">42 minutes</div>
																</div>
															</div>
														</div>
														<h3 class="font-semibold">The Science of Happiness</h3>
													</div>
													<div class="w-full">
														<p>This episode discusses the psychology of happiness.</p>
													</div>
												</a>
											</div>
											<div role="group" class="splide__slide group w-dyn-item splide__slide--clone"
											     id="splide01-clone03" aria-roledescription="slide" aria-label="5 of 8"
											     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);" aria-hidden="true">
												<a href="#"
												   class="w-full flex flex-col gap-20 h-full w-inline-block"
												   tabindex="-1">
											...
											<div role="group" class="splide__slide group w-dyn-item splide__slide--clone"
											     id="splide01-clone04" aria-roledescription="slide" aria-label="6 of 8"
											     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);" aria-hidden="true">
												<a href="#"
												   class="w-full flex flex-col gap-20 h-full w-inline-block"
												   tabindex="-1">
													<div class="w-full h-full">
														<div class="mb-28">
															<div class="overflow-hidden rounded-12 relative h-220 bg-cargogrey">
																<img
																	src="https://cdn.prod.website-files.com/686225582293e0967d2b9375/68937a163918d6a1775ef765_image2.jpeg"
																	loading="lazy" alt="Financial literacy podcast episode"
														...
														<h3 class="font-semibold">Financial Literacy for Everyone</h3>
													</div>
													<div class="w-full">
														<p>We discuss the importance of financial literacy and budgeting.</p>
													</div>
												</a>
											</div>
											<div role="group" class="splide__slide group w-dyn-item splide__slide--clone"
											     id="splide01-clone05" aria-roledescription="slide" aria-label="7 of 8"
											     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);" aria-hidden="true">
												<a href="#"
												   class="w-full flex flex-col gap-20 h-full w-inline-block"
												   tabindex="-1">
													<div class="w-full h-full">
														<div class="mb-28">
															<div class="overflow-hidden rounded-12 relative h-220 bg-cargogrey">
																<img
																	...
																	loading="lazy" alt="Storytelling podcast episode" class="image relative opacity-40">
																<div class="absolute absolute--tl p-24">
																	<div class="rounded-full text-white py-4 px-8 text-center relative overflow-hidden">
																		<div class="font-semibold text-2xs uppercase relative z-1 w-condition-invisible">
																			Digital Marketing
														...
														<h3 class="font-semibold">The Art of Storytelling</h3>
													</div>
													<div class="w-full">
														<p>We explore various storytelling techniques and their impact.</p>
													</div>
												</a>
											</div>
											<div role="group" class="splide__slide group w-dyn-item splide__slide--clone"
											     id="splide01-clone06" aria-roledescription="slide" aria-label="8 of 8"
											     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);" aria-hidden="true">
												<a href="#"
												   class="w-full flex flex-col gap-20 h-full w-inline-block"
												   tabindex="-1">
													<div class="w-full h-full">
														<div class="mb-28">
															<div class="overflow-hidden rounded-12 relative h-220 bg-cargogrey">
																<img
																	src="https://cdn.prod.website-files.com/686225582293e0967d2b9375/68937a163918d6a1775ef706_image9.jpeg"
																	loading="lazy" alt="Health and wellness podcast episode"
																	class="image relative opacity-40">
																<div class="absolute absolute--tl p-24">
																	<div class="rounded-full text-white py-4 px-8 text-center relative overflow-hidden">
																		<div class="font-semibold text-2xs uppercase relative z-1 w-condition-invisible">
														...
														<h3 class="font-semibold">Health and Wellness in the Modern Age</h3>
													</div>
													<div class="w-full">
														<p>This episode focuses on mental health and wellness strategies.</p>
													</div>
												</a>
											</div>
											<div role="group" class="splide__slide group w-dyn-item is-prev" id="splide01-slide01"
												...
												<a href="#"
												   ...
												   tabindex="-1">
													<div class="w-full h-full">
														...
														<div class="mb-12">
															<div class="flex items-center gap-32 sm:flex-wrap sm:gap-8">
																...
																<div class="flex items-center gap-8">
																	<div class="font-family-secondary font-light text-xs">October 15, 2023</div>
																	<div>•</div>
																	<div class="font-family-secondary font-light text-xs">30 minutes</div>
																</div>
															</div>
													...
													<div class="w-full">
														<p>Join us as we discuss sustainable living practices and their impact on
															the environment.
														</p>
													</div>
												</a>
											</div>
											<div role="group" class="splide__slide group w-dyn-item is-visible is-active"
											     id="splide01-slide02" aria-roledescription="slide" aria-label="2 of 8"
											...
											<div role="group" class="splide__slide group w-dyn-item is-visible is-next" id="splide01-slide03"
											...
											<div role="group" class="splide__slide group w-dyn-item is-visible" id="splide01-slide04"
											...
											<div role="group" class="splide__slide group w-dyn-item splide__slide--clone"
											     id="splide01-clone07" aria-roledescription="slide" aria-label="1 of 8"
											     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);" aria-hidden="true">
												<a href="#"
												   class="w-full flex flex-col gap-20 h-full w-inline-block"
												   tabindex="-1">
											...
											<div role="group" class="splide__slide group w-dyn-item splide__slide--clone is-active"
											     id="splide01-clone08" aria-roledescription="slide" aria-label="2 of 8"
											     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);" aria-hidden="true">
												<a href="#"
												   class="w-full flex flex-col gap-20 h-full w-inline-block"
												   tabindex="-1">
											...
											<div role="group" class="splide__slide group w-dyn-item splide__slide--clone"
											     id="splide01-clone09" aria-roledescription="slide" aria-label="3 of 8"
											     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);" aria-hidden="true">
												<a href="#"
												   class="w-full flex flex-col gap-20 h-full w-inline-block"
												   tabindex="-1">
											...
											<div role="group" class="splide__slide group w-dyn-item splide__slide--clone"
											     id="splide01-clone10" aria-roledescription="slide" aria-label="4 of 8"
											     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);" aria-hidden="true">
												<a href="#"
												   class="w-full flex flex-col gap-20 h-full w-inline-block"
												   tabindex="-1">
											...
											<div role="group" class="splide__slide group w-dyn-item splide__slide--clone"
											     id="splide01-clone11" aria-roledescription="slide" aria-label="5 of 8"
											     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);" aria-hidden="true">
												<a href="#"
												   class="w-full flex flex-col gap-20 h-full w-inline-block"
												   tabindex="-1">
											...
											<div role="group" class="splide__slide group w-dyn-item splide__slide--clone"
											     id="splide01-clone12" aria-roledescription="slide" aria-label="6 of 8"
											     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);" aria-hidden="true">
												<a href="#"
												   class="w-full flex flex-col gap-20 h-full w-inline-block"
												   tabindex="-1">
									...
									<div class="splide__arrows splide__arrows--ltr">
										...
										<div class="splide__arrow splide__arrow--next" aria-label="Next slide"
										     aria-controls="splide01-track">
											<div class="flex w-embed">
												<svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" viewBox="0 0 42 42" fill="none">
													<path
							...
							<div class="w-layout-blockcontainer max-w-1252 w-container">
								<div slider-2=""
									...
									<div class="splide__track w-dyn-list splide__track--loop splide__track--ltr splide__track--draggable"
									     ...
									     aria-atomic="true" aria-busy="false">
										<div role="presentation" class="splide__list w-dyn-items" id="splide02-list"
										     style="transform: translateX(-2995.89px);">
											<div role="group" class="splide__slide group w-dyn-item splide__slide--clone"
											     id="splide02-clone01" aria-roledescription="slide" aria-label="3 of 8"
											     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);" aria-hidden="true">
												<a href="#"
												   class="w-full flex flex-col gap-20 h-full w-inline-block"
												   tabindex="-1">
											...
											<div role="group" class="splide__slide group w-dyn-item splide__slide--clone"
											     id="splide02-clone02" aria-roledescription="slide" aria-label="4 of 8"
											     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);" aria-hidden="true">
												<a href="#"
												   class="w-full flex flex-col gap-20 h-full w-inline-block"
												   tabindex="-1">
											...
											<div role="group" class="splide__slide group w-dyn-item splide__slide--clone"
											     id="splide02-clone03" aria-roledescription="slide" aria-label="5 of 8"
											     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);" aria-hidden="true">
												<a href="#"
												   class="w-full flex flex-col gap-20 h-full w-inline-block"
												   tabindex="-1">
											...
											<div role="group" class="splide__slide group w-dyn-item splide__slide--clone"
											     id="splide02-clone04" aria-roledescription="slide" aria-label="6 of 8"
											     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);" aria-hidden="true">
												<a href="#"
												   class="w-full flex flex-col gap-20 h-full w-inline-block"
												   tabindex="-1">
											...
											<div role="group" class="splide__slide group w-dyn-item splide__slide--clone"
											     id="splide02-clone05" aria-roledescription="slide" aria-label="7 of 8"
											     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);" aria-hidden="true">
												<a href="#"
												   class="w-full flex flex-col gap-20 h-full w-inline-block"
												   tabindex="-1">
											...
											<div role="group" class="splide__slide group w-dyn-item splide__slide--clone"
											     id="splide02-clone06" aria-roledescription="slide" aria-label="8 of 8"
											     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);" aria-hidden="true">
												<a href="#"
												   class="w-full flex flex-col gap-20 h-full w-inline-block"
												   tabindex="-1">
											...
											<div role="group" class="splide__slide group w-dyn-item is-prev" id="splide02-slide01"
											     aria-roledescription="slide" aria-label="1 of 8"
											     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);" aria-hidden="true">
												<a href="#"
												   class="w-full flex flex-col gap-20 h-full w-inline-block"
											...
											<div role="group" class="splide__slide group w-dyn-item is-visible is-active"
											     id="splide02-slide02" aria-roledescription="slide" aria-label="2 of 8"
											     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);">
												<a href="#"
												   class="w-full flex flex-col gap-20 h-full w-inline-block">
													<div class="w-full h-full">
											...
											<div role="group" class="splide__slide group w-dyn-item is-visible is-next" id="splide02-slide03"
											     aria-roledescription="slide" aria-label="3 of 8"
											     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);">
												<a href="#"
												   class="w-full flex flex-col gap-20 h-full w-inline-block">
											...
											<div role="group" class="splide__slide group w-dyn-item is-visible" id="splide02-slide04"
											     aria-roledescription="slide" aria-label="4 of 8"
											     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);">
												<a href="#"
												   class="w-full flex flex-col gap-20 h-full w-inline-block">
											...
											<div role="group" class="splide__slide group w-dyn-item splide__slide--clone"
											     id="splide02-clone07" aria-roledescription="slide" aria-label="1 of 8"
											     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);" aria-hidden="true">
												<a href="#"
												   class="w-full flex flex-col gap-20 h-full w-inline-block"
												   tabindex="-1">
											...
											<div role="group" class="splide__slide group w-dyn-item splide__slide--clone is-active"
											     id="splide02-clone08" aria-roledescription="slide" aria-label="2 of 8"
											     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);" aria-hidden="true">
												<a href="#"
												   class="w-full flex flex-col gap-20 h-full w-inline-block"
												   tabindex="-1">
											...
											<div role="group" class="splide__slide group w-dyn-item splide__slide--clone"
											     id="splide02-clone09" aria-roledescription="slide" aria-label="3 of 8"
											     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);" aria-hidden="true">
												<a href="#"
												   class="w-full flex flex-col gap-20 h-full w-inline-block"
												   tabindex="-1">
											...
											<div role="group" class="splide__slide group w-dyn-item splide__slide--clone"
											     id="splide02-clone10" aria-roledescription="slide" aria-label="4 of 8"
											     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);" aria-hidden="true">
												<a href="#"
												   class="w-full flex flex-col gap-20 h-full w-inline-block"
												   tabindex="-1">
											...
											<div role="group" class="splide__slide group w-dyn-item splide__slide--clone"
											     id="splide02-clone11" aria-roledescription="slide" aria-label="5 of 8"
											     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);" aria-hidden="true">
												<a href="#"
												   class="w-full flex flex-col gap-20 h-full w-inline-block"
												   tabindex="-1">
											...
											<div role="group" class="splide__slide group w-dyn-item splide__slide--clone"
											     id="splide02-clone12" aria-roledescription="slide" aria-label="6 of 8"
											     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);" aria-hidden="true">
												<a href="#"
												   class="w-full flex flex-col gap-20 h-full w-inline-block"
												   tabindex="-1">
					...
					<div class="relative">
						<div class="w-layout-blockcontainer max-w-1252 w-container">
							<div slider-3=""
								...
								<div class="splide__track w-dyn-list splide__track--loop splide__track--ltr splide__track--draggable"
								     id="splide03-track" style="padding-left: 0px; padding-right: 0px;" aria-live="off"
								     aria-atomic="true" aria-busy="false">
									<div role="presentation" class="splide__list w-dyn-items" id="splide03-list"
									     style="transform: translateX(-2995.89px);">
														...
														<div class="overflow-hidden rounded-12 relative h-220 bg-cargogrey">
															...
															<div class="absolute absolute--tl p-24">
																<div class="rounded-full text-white py-4 px-8 text-center relative overflow-hidden">
																	...
																	<div class="absolute absolute--full w-full h-full bg-primary"></div>
																	<div
																		class="absolute absolute--full w-full h-full bg-tertiary w-condition-invisible"></div>
																</div>
															</div>
										...
										<div role="group" class="splide__slide group w-dyn-item splide__slide--clone" id="splide03-clone06"
												...
												<div class="w-full h-full">
													<div class="mb-28">
														<div class="overflow-hidden rounded-12 relative h-220 bg-cargogrey">
															...
															<div class="absolute absolute--tl p-24">
																<div class="rounded-full text-white py-4 px-8 text-center relative overflow-hidden">
																	<div class="font-semibold text-2xs uppercase relative z-1 w-condition-invisible">User
																		Experience
																	</div>
																	<div
																		class="font-semibold text-2xs uppercase relative z-1 text-white w-condition-invisible">
										...
										<div role="group" class="splide__slide group w-dyn-item is-prev" id="splide03-slide01"
										...
										<div role="group" class="splide__slide group w-dyn-item is-visible is-active" id="splide03-slide02"
										...
										<div role="group" class="splide__slide group w-dyn-item is-visible is-next" id="splide03-slide03"
										...
										<div role="group" class="splide__slide group w-dyn-item is-visible" id="splide03-slide04"
										...
										<div role="group" class="splide__slide group w-dyn-item splide__slide--clone" id="splide03-clone07"
										     aria-roledescription="slide" aria-label="1 of 10"
										     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);" aria-hidden="true">
											<a href="#"
											   class="w-full flex flex-col gap-20 h-full w-inline-block"
										...
										<div role="group" class="splide__slide group w-dyn-item splide__slide--clone is-active"
										     id="splide03-clone08" aria-roledescription="slide" aria-label="2 of 10"
										     style="margin-right: 32px; width: calc(33.3333% - 21.3333px);" aria-hidden="true">
											<a href="#"
											   class="w-full flex flex-col gap-20 h-full w-inline-block"
											   tabindex="-1">
		...
		<section class="section rounded-t-100 overflow-hidden text-white">
			<div class="site-padding sm:py-60 py-164">
				<div class="w-layout-blockcontainer max-w-816 text-center w-container">
					<div class="mb-44">
						<h2 class="text-45">Follow Supply Chain Now for the latest updates, insights, and
							news.
						</h2>
					</div>
			...
			<div class="absolute absolute--full w-full h-full z--1">
				<img loading="lazy"
				     ...
				     alt="bg-footer-cta-media-kit"
				     class="image opacity-15">
			</div>
		</section>
	</div>
</div>
