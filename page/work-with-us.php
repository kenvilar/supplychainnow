	...
	<div class="main-wrapper">
		<section class="section bg-cargogrey text-white rounded-b-100">
			...
			<div class="absolute absolute--full w-full h-full">
				<img
					src="https://cdn.prod.website-files.com/6858d0b082937600c76df99a/688c5b4d4aa91ceed4b566dd_hero-work%20with%20us.avif"
				...
				<div class="w-layout-blockcontainer max-w-1252 w-container">
					<div class="flex gap-20 justify-between sm:flex-col items-center sm:gap-40">
						<div class="max-w-568 w-full md:max-w-full">
							...
							<p class="tracking-[1.6px]">Supply chain brands are turning to webinars and livestreams to drive 10x more
								engagement than traditional ads, leveraging the forms of content that decision-makers are actively
								...
								<div class="max-w-288 w-full md:max-w-full group transition-all hover:-translate-y-25">
									<div class="text-center rounded-t-24 overflow-hidden relative px-20 pt-48 pb-148 cursor-pointer">
										<div class="w-layout-blockcontainer max-w-200 w-full md:max-w-full w-container">
											...
											<div class="mb-12">
												<div class="font-family-secondary text-36 tracking-[3.6px] text-secondary">50%</div>
											</div>
											<div class="mb-28">
												<div class="text-md font-semibold">Webinar attendance rate over the last 18 months</div>
											</div>
										</div>
								...
								<div class="max-w-288 w-full md:max-w-full group transition-all hover:-translate-y-25">
									<div class="text-center rounded-t-24 overflow-hidden relative px-20 pt-48 pb-112 cursor-pointer">
										<div class="w-layout-blockcontainer max-w-200 w-full md:max-w-full w-container">
											...
											<div class="mb-12">
												<div class="font-family-secondary text-36 tracking-[3.6px] text-secondary">30-35%</div>
											</div>
											<div class="mb-28">
												<div class="text-md font-semibold">Webinar attendance rate, according to the industry average
												</div>
											</div>
										</div>
										<div class="absolute absolute--full w-full h-full z--1">
			...
			<div class="site-padding sm:py-60 py-72">
				...
				<div class="w-layout-blockcontainer max-w-1248 relative sm:text-center w-container">
					...
					<div class="absolute absolute--full w-full flex items-center justify-center z--1">
						<img
							src="https://cdn.prod.website-files.com/6858d0b082937600c76df99a/688c8f4069cbd1883847f36a_12-day-timeline.avif"
				...
				<div class="w-layout-blockcontainer max-w-1264 w-container">
					<div class="flex justify-center">
						<img
							src="https://cdn.prod.website-files.com/6858d0b082937600c76df99a/688c91a468546e4f7ad2c632_120%20day%20timeline.avif"
				...
				<div class="site-padding sm:py-60 py-84">
					<div class="w-layout-blockcontainer max-w-1200 w-container">
						...
						<div class="flex items-center justify-center">
							<img
								src="https://cdn.prod.website-files.com/6858d0b082937600c76df99a/688c988cab2a187605417510_results%20that%20keep%20building.avif"
				...
				<div class="w-layout-blockcontainer max-w-1252 text-center w-container">
					...
					<div class="flex gap-20 justify-between md:flex-col">
						<div>
							...
							<div class="mb-8">
								<div class="font-family-secondary font-semibold text-md">of all Global Podcasts</div>
							</div>
						...
						<div class="max-w-124 w-full md:max-w-full">
							...
							<div class="mb-8">
								<div class="font-family-secondary font-semibold text-md">Average Registrations</div>
							</div>
						</div>
						<div class="w-1 bg-secondary/25"></div>
						<div class="max-w-120 w-full md:max-w-full">
							...
							<div class="mb-8">
								<div class="font-family-secondary font-semibold text-md">of Leads per Webinar</div>
							</div>
						</div>
						<div class="w-1 bg-secondary/25"></div>
						<div class="max-w-188 w-full md:max-w-full">
							...
							<div class="mb-8">
								<div class="font-family-secondary font-semibold text-md">as Hosts &amp; Co-Hosts</div>
							</div>
						</div>
						<div class="w-1 bg-secondary/25"></div>
						<div class="max-w-140 w-full md:max-w-full">
							...
							<div class="mb-8">
								<div class="font-family-secondary font-semibold text-md">Total Network Following</div>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="overflow-hidden relative rounded-t-100">
			...
			<div class="absolute absolute--b z--1 flex justify-center">
				<img src="https://cdn.prod.website-files.com/6858d0b082937600c76df99a/6866b4e3e71341e104c8b90f_double-ring.avif"
