	...
	<div class="main-wrapper">
		<section class="section bg-cargogrey text-white rounded-b-100">
			...
			<div class="absolute absolute--full w-full h-full">
				<img
					src="https://cdn.prod.website-files.com/6858d0b082937600c76df99a/6891a95f778705f4b4111680_hero--articles.avif"
					loading="lazy" alt="hero--articles" class="image opacity-10">
			</div>
		</section>
			...
			<div class="site-padding py-0">
				<div class="w-layout-blockcontainer max-w-full w-container">
					<div class="flex justify-center items-center sm:flex-col">
						...
						<a href="/article" aria-current="page" class="resource-hub-link w-inline-block w--current">
							<div>Article</div>
						</a>
						...
						<div role="list" class="flex justify-center gap-28 sm:flex-col w-dyn-items">
							<div role="listitem" class="w-full group w-dyn-item">
								<div class="flex flex-col gap-20 h-full">
									...
									<div class="w-full">
										<div class="rt--plain truncate-2-lines-fallback w-richtext">CMS Troubleshooting TipsEncountering
											issues with your CMS? Here are some troubleshooting tips:1. Check for UpdatesEnsure your CM...
										</div>
									</div>
								</div>
							</div>
							<div role="listitem" class="w-full group w-dyn-item">
								<div class="flex flex-col gap-20 h-full">
									...
									<div class="w-full">
										<div class="rt--plain truncate-2-lines-fallback w-richtext">Using CMS for E-commerceContent
											management systems can significantly enhance e-commerce operations. Here’s how:1. Produc...
										</div>
									</div>
								</div>
							</div>
