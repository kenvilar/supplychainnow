								...
								<div class="mb-60">
									<div class="flex gap-24 items-center">
										...
										<div class="flex items-center gap-12">
											...
											<a href="<?php
											if ($youtube_url) {
												echo 'https://www.youtube.com/channel/UCuqKDp8uxinIM8ORIOLr0qw'; //esc_url($youtube_url);
											} ?>" class="btn primary-outline w-inline-block" target="_blank" rel="noopener noreferrer">
												<div class="flex items-center gap-8">
													<div>Watch on Youtube</div>
													<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
													     fill="none">
														<path d="M11.625 10L9 8.5V11.5L11.625 10Z" fill="#FFAB56"/>
														<path fill-rule="evenodd" clip-rule="evenodd"
		...
		<div class="relative">
			<div class="min-h-990 h-full flex justify-center pt-70 pb-57 px-32">
				<div class="w-layout-blockcontainer max-w-841 w-full md:max-w-full w-container">
					...
					<div class="mb-36 flex items-center gap-15">
						<div class="tracking-[1.6px]">Share:</div>
						<div class="flex gap-8 items-center">
							<a href="#" class="text-secondary hover:text-primary">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
