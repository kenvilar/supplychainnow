...
if ( get_post_meta( $bridge_qode_page_id, 'qode_choose_content_bottom_sidebar', true ) != "" ) {
    $bridge_qode_content_bottom_area_sidebar = get_post_meta(
            $bridge_qode_page_id,
...
if ( get_post_meta( $bridge_qode_page_id, 'qode_content_bottom_sidebar_in_grid', true ) != "" ) {
    ...
    if ( isset( $bridge_qode_options['content_bottom_in_grid'] ) ) {
        if ( $bridge_qode_options['content_bottom_in_grid'] == "no" ) {
            $bridge_qode_content_bottom_area_in_grid = false;
        }
    }
}
...
if ( get_post_meta( $bridge_qode_page_id, "qode_content_bottom_background_color", true ) != "" ) {
    $bridge_qode_content_bottom_background_color = get_post_meta(
            $bridge_qode_page_id,
...
?>
<?php
if ( $bridge_qode_content_bottom_area == "yes" ) { ?>
    <?php
    if ( $bridge_qode_content_bottom_area_in_grid ) { ?>
        <div class="container">
        <div class="container_inner clearfix">
        <?php
    } ?>
    <div class="content_bottom" <?php
    if ( $bridge_qode_content_bottom_background_color != '' ) {
        echo 'style="background-color:' . $bridge_qode_content_bottom_background_color . ';"';
    } ?>>
        <?php
        dynamic_sidebar( $bridge_qode_content_bottom_area_sidebar ); ?>
    </div>
    <?php
    if ( $bridge_qode_content_bottom_area_in_grid ) { ?>
        </div>
...
if ( isset( $bridge_qode_options['paspartu'] ) && $bridge_qode_options['paspartu'] == 'yes' ) {
    ...
    <?php
    if ( ( isset( $bridge_qode_options['paspartu_on_bottom'] ) && $bridge_qode_options['paspartu_on_bottom'] == 'yes' )
        ...
        <div class="footer_inner clearfix">
            ...
            if ( $bridge_qode_display_footer_top ) { ?>
                <div class="footer_top_holder">
                    ...
                    if ( $bridge_qode_footer_top_border_color !== '' ) { ?>
                        <div <?php
                        bridge_qode_inline_style( $bridge_qode_footer_top_border_style ); ?> <?php
                        bridge_qode_class_attribute(
                                'footer_top_border ' . $bridge_qode_footer_top_border_in_grid_class
                        ); ?>></div>
                        <?php
                    } ?>
                    <div class="footer_top<?php
                    if ( ! $bridge_qode_footer_in_grid ) {
                        ...
                        <div class="container">
                            <div class="container_inner">
                                ...
                                <?php
                                switch ( $bridge_qode_footer_top_columns ) {
                                    case 6:
                                        ?>
                    ...
                    <?php
                    if ( isset( $bridge_qode_options['footer_angled_section'] ) && $bridge_qode_options['footer_angled_section'] == "yes" ) { ?>
                        <svg class="angled-section svg-footer-bottom" preserveAspectRatio="none" viewBox="0 0 86 86"
                             width="100%" height="86">
                            <?php
                            if ( isset( $bridge_qode_options['footer_angled_section_direction'] ) && $bridge_qode_options['footer_angled_section_direction'] == 'from_left_to_right' ) { ?>
            ...
            if ( $bridge_qode_display_footer_text ) { ?>
                <div class="footer_bottom_holder">
                    ...
                    if ( $bridge_qode_footer_bottom_border_color !== '' ) { ?>
                        <div <?php
                        bridge_qode_inline_style( $bridge_qode_footer_bottom_border_style ); ?> <?php
                        bridge_qode_class_attribute(
                                'footer_bottom_border ' . $bridge_qode_footer_bottom_border_in_grid_class
                        ); ?>></div>
                        <?php
                    } ?>
                    <?php
                    if ( $bridge_qode_footer_bottom_in_grid ){ ?>
                    <div class="container">
                        <div class="container_inner">
                            <?php
                            } ?>
                                    ...
                                    <div class="two_columns_50_50 footer_bottom_columns clearfix">
                                        <div class="column1 footer_bottom_column">
                                            <div class="column_inner">
                                                <div class="footer_bottom">
                                                    <?php
                                                    dynamic_sidebar( 'footer_text_left' ); ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="column2 footer_bottom_column">
                                            <div class="column_inner">
                                                <div class="footer_bottom">
                                                    <?php
                                                    dynamic_sidebar( 'footer_text_right' ); ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
