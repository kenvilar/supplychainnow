...
<section class="section bg-cargogrey text-white rounded-b-100">
	...
	<div class="absolute absolute--full w-full h-full">
		<img
			src="https://cdn.prod.website-files.com/6858d0b082937600c76df99a/6891aa0d9265a71b203b5033_hero--guides.avif"
			loading="lazy" alt="hero--guides" class="image opacity-10">
	</div>
</section>
