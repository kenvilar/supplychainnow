...
$pageID = get_the_ID();
$page_title = get_field("Page_Title", $pageID) ?: "Campaign Directory";
$hero_image = esc_url(get_field("Hero_Image", $pageID) ?: get_stylesheet_directory_uri() . "/assets/img/hero-img/hero--campaign-directory.avif");
$icon = esc_url(get_field("Icon", $pageID) ?: get_stylesheet_directory_uri() . "/assets/img/icons/notebook-with-one-person.svg");
