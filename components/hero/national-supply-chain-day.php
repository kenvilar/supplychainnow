...
$pageID = get_the_ID();
$page_title = get_field("Page_Title", $pageID) ?: "A Celebration and Spotlight of the Industry That Connects the World";
$description = esc_html(get_field("Description", $pageID) ?: "");
$hero_image = esc_url(get_field("Hero_Image", $pageID) ?: get_stylesheet_directory_uri() . "/assets/img/hero-img/hero--national-supply-chain-day.avif");
$icon = esc_url(get_field("Icon", $pageID) ?: get_stylesheet_directory_uri() . "/assets/img/national-supply-chain-day/national-supply-chain-day.avif");
