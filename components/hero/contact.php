...
$pageID = get_the_ID();
$page_title = get_field("Page_Title", $pageID) ?: "Contact Us";
$description = esc_html(get_field("Description", $pageID) ?: "Have a question? Suggestion? Idea for a partnership? Please fill out the form and we'll get back to you as soon as possible.");
$hero_image = esc_url(get_field("Hero_Image", $pageID) ?: get_stylesheet_directory_uri() . "/assets/img/hero-img/hero--contact.avif");
$icon = esc_url(get_field("Icon", $pageID) ?: get_stylesheet_directory_uri() . "/assets/img/icons/convo.svg");
