...
<section class="section bg-cargogrey text-white rounded-b-100">
	...
	<div class="absolute absolute--full w-full h-full">
		<img
			src="https://cdn.prod.website-files.com/6858d0b082937600c76df99a/6891a9023c2e56b6a2a0e2f2_hero--ebooks.avif"
			loading="lazy" alt="hero--ebooks" class="image opacity-10">
	</div>
</section>
