...
$pageID = get_the_ID();
$page_title = get_field("Page_Title", $pageID) ?: "Explore Our Resource Hub";
$icon = esc_url(get_field("Icon", $pageID) ?: get_stylesheet_directory_uri() . "/assets/img/icons/3by3.svg");
...
<section class="section bg-cargogrey text-white rounded-b-100 sm:rounded-b-none">
	...
	<div class="absolute absolute--full w-full h-full">
		<img
			src="<?php if (get_field("Hero_Image", $pageID)) {
