		...
		<div class="w-layout-blockcontainer max-w-1372 relative w-container">
			...
			<div class="relative">
				<div class="w-layout-blockcontainer max-w-1252 w-container">
					<div slider-2="" class="splide splide--slide splide--ltr splide--draggable is-active is-initialized"
												...
												<div class="overflow-hidden rounded-12 relative h-220 bg--cargogrey">
													...
													<div class="absolute absolute--tl p-24">
														<div class="rounded-full text--white py-4 px-8 text-center relative overflow-hidden">
															...
															<div class="font-semibold text-2xs uppercase relative z-1 text--white">Digital
																Marketing
															</div>
															<div
																class="absolute absolute--full _w-full h-full bg--primary w-condition-invisible"></div>
															<div class="absolute absolute--full _w-full h-full bg--tertiary"></div>
														</div>
													</div>
													<div
												...
												<div class="overflow-hidden rounded-12 relative h-220 bg--cargogrey">
													...
													<div class="absolute absolute--tl p-24">
														<div class="rounded-full text--white py-4 px-8 text-center relative overflow-hidden">
															...
															<div class="font-semibold text-2xs uppercase relative z-1 text--white">Content
																Management
															</div>
															<div
																class="absolute absolute--full _w-full h-full bg--primary w-condition-invisible"></div>
