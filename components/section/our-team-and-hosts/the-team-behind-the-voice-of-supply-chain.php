...
<section class="section">
				...
				<div class="max-w-608 w-full md:max-w-full sm:order-2">
					<div class="mb-36">
						<div class="max-w-460 w-full md:max-w-full">
							<h2 class="font-semibold text-36">The Team Behind the Voice of Supply Chain</h2>
						</div>
					</div>
					<p class="tracking-[1.6px]">We’re only able to accomplish what we do thanks to the contributions of each
	...
	<div class="absolute absolute--full w-full h-full flex items-center justify-center z--1">
		<img loading="lazy"
		     src="https://cdn.prod.website-files.com/6858d0b082937600c76df99a/6869f147405fd774ebf946b2_bg-grid.avif"
		     alt="bg-grid">
	</div>
</section>
