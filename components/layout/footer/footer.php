								...
								<div class="w-layout-vflex flex gap-16">
									...
									<ul role="list" class="m-0 flex flex-col gap-12 w-list-unstyled">
										...
										<li class="flex flex-col gap-12">
											<a href="/our-team-and-hosts" class="footer-link">Our Team &amp; Hosts</a>
										</li>
									</ul>
								</div>
							</div>
							<div>
								<div class="w-layout-vflex flex gap-16">
									...
									<ul role="list" class="m-0 flex flex-col gap-12 w-list-unstyled">
										...
										<li>
											<a href="/national-supply-chain-day" class="footer-link">National Supply Chain Day</a>
										</li>
										<li>
											<a href="/on-the-road" class="footer-link">On The Road</a>
										</li>
									</ul>
								</div>
							</div>
							<div>
								<div class="w-layout-vflex flex gap-16">
									...
									<ul role="list" class="m-0 flex flex-col gap-12 w-list-unstyled">
										...
										<li>
											<a href="/media-kit" class="footer-link">Media Kit</a>
										</li>
									</ul>
								</div>
							</div>
							<div>
								<div class="w-layout-vflex flex gap-16">
									...
									<ul role="list" class="m-0 flex flex-col gap-12 w-list-unstyled">
										...
										<li class="flex flex-col gap-12">
											<a href="#" class="footer-link not-link">Network Partners</a>
											<ul role="list" class="m-0 flex flex-col gap-8 w-list-unstyled">
												<li>
													<a href="/easypost" class="footer-link-sub">EasyPost</a>
												</li>
												<li>
													<a href="/enable" class="footer-link-sub">Enable</a>
												</li>
												<li>
													<a href="/us-bank" class="footer-link-sub">U.S. Bank</a>
												</li>
											</ul>
										</li>
										<li class="flex flex-col gap-12">
											<a href="#" class="footer-link not-link">Campaign Partners</a>
											<ul role="list" class="m-0 flex flex-col gap-8 w-list-unstyled">
												<li>
													<a href="/altium" class="footer-link-sub">Altium</a>
												</li>
												<li>
													<a href="/autoscheduler" class="footer-link-sub">AutoScheduler.AI</a>
												</li>
												<li>
													<a href="/bem" class="footer-link-sub">bem</a>
												</li>
												<li>
													<a href="/coupa" class="footer-link-sub">Coupa</a>
												</li>
												<li>
													<a href="/doss" class="footer-link-sub">Doss</a>
												</li>
												<li>
													<a href="/ratelinx" class="footer-link-sub">RateLinx</a>
												</li>
												<li>
													<a href="/sap" class="footer-link-sub">SAP</a>
												</li>
												<li>
													<a href="/trucker-tools" class="footer-link-sub">Trucker Tools</a>
												</li>
												<li>
													<a href="/bastian-solutions" class="footer-link-sub">Bastian Solutions</a>
												</li>
												<li>
													<a href="/dp-world" class="footer-link-sub">DP World</a>
												</li>
												<li>
													<a href="/omp" class="footer-link-sub">OMP</a>
												</li>
												<li>
													<a href="/zebra-technologies" class="footer-link-sub">Zebra Technologies</a>
												</li>
											</ul>
										</li>
									</ul>
