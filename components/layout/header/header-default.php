	...
	<div class="display-none">
		<!--<div class="display-none w-embed">
			<style>
				...
				.nav_dropdown_link-sub:hover {
					color: var(--primary) !important;
				}
				.nav-dropdown__toggle.w--open .group-hover\:opacity-100 {
					opacity: 1;
				}
				...
				.nav-dropdown__toggle.w--open .nav-dropdown__toggle-icon {
				...
				.navlink_cta__group a {
					/*color: inherit !important;*/
				}
				/* If nav is fixed */
				.nav.fixed .nav__brandlink {
					filter: brightness(0) saturate(100%) invert(100%) sepia(0%) saturate(0%) hue-rotate(300deg) brightness(104%) contrast(101%);
				}
				.nav.fixed .nav-dropdown__toggle,
				.nav.fixed .nav__link {
					color: white;
				}
				/* If nav is not fixed but nav background color is text-color or cargo grey */
				.nav.bg-textcolor:not(.fixed) .navlink__group .nav_dropdown_link,
				.nav.bg-textcolor:not(.fixed) .navlink__group .nav_dropdown_link-sub {
					color: var(--text-color);
				}
				.nav.bg-textcolor:not(.fixed) .navlink__group .nav-dropdown__toggle {
					color: white;
				}
				@media screen and (max-width: 991px) {
					...
					.w--open .navmenu__icon-bar.top {
						transform: rotate(45deg) translateX(0px) translateY(0px);
					}
					.w--open .navmenu__icon-bar.middle {
						opacity: 0;
					}
					.w--open .navmenu__icon-bar.bottom {
						transform: rotate(-45deg) translateX(0px) translateY(0px);
					}
					/* If nav is fixed */
					.nav.fixed {
