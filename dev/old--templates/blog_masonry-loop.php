		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<div class="post_text">
				<div class="post_text_inner">
					...
					<div class="post_info">
						<span itemprop="dateCreated" class="time entry_date updated"><?php the_time('F j, Y'); ?><meta itemprop="interactionCount" content="UserComments: <?php echo get_comments_number(bridge_qode_get_page_id()); ?>"/></span>
			...
			<div class="post_text">
				<div class="post_text_inner">
					...
					<?php if ( ! post_password_required() ) { ?>
							 <div class="post_more" style="text-align: center;">
