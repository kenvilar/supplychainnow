            ...
            <div class="content_inner">
                <div class="full_width">
                    <div class="full_width_inner">
                                        ...
                                        <div class="vc_column-inner">
                                            <div class="wpb_wrapper">
                                                <div class="wpb_text_column wpb_content_element">
                                                    <div class="wpb_wrapper">
                                                        <h1 style="text-align: center;">LIVESTREAM: <?php echo get_field( "livestream_title" ,$pageId); ?></h1>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="wpb_video_widget wpb_content_element vc_clearfix vc_video-aspect-ratio-169 vc_video-el-width-100 vc_video-align-left">
                                                    <div class="wpb_wrapper">
                                                        <div class="wpb_video_wrapper">
                                                            <?php echo the_field('youtube_embed_link',$pageId);  ?>
                                                        </div>
                                                    </div>
                                                </div>
											<?php } ?>
						...
						<?php if(!empty(get_field('livestream_description',$pageId))){ ?>
                                                ...
                                                <div class="wpb_text_column wpb_content_element custom-font-one">
                                                    <div class="wpb_wrapper">
                                                        <p style="text-align: center;">
                                                            <?php echo get_field( "livestream_description",$pageId ); ?>
                                                        </p>
                                                        <!--p style="text-align: center;">
						...
						<?php } ?>
                        <div class="vc_row wpb_row section vc_row-fluid grid_section" style="padding-top: 60px; padding-bottom: 0px; text-align: left;">
                            <div class="section_inner clearfix">
                                <div class="section_inner_margin clearfix">
                                    <div class="wpb_column vc_column_container vc_col-sm-12">
                                        <div class="vc_column-inner">
											...
											<?php											
                                                ...
                                                <div class="vc_row wpb_row section vc_row-fluid vc_inner" style="padding-top: 40px; padding-bottom: 40px; text-align: left;">
                                                    <div class="full_section_inner clearfix">
                                                        <div class="wpb_column vc_column_container vc_col-sm-12">
                                                            <div class="vc_column-inner">
                                                                <div class="wpb_wrapper">
