...
<div class="wrapper">
	<div class="wrapper_inner">
		<?php
		do_action( 'bridge_qode_action_after_wrapper_inner' ); ?>
		...
		echo bridge_qode_get_paspartu_class(); ?>">
			...
			<div class="paspartu_middle_inner">
				...
				<div class="paspartu_inner">
					...
					<?php
					if ( is_active_sidebar( 'left_side_fixed' ) ) { ?>
					...
					<?php
					if ( is_active_sidebar( 'right_side_fixed' ) ) { ?>
						...
						if ( in_array( bridge_qode_options()->getOptionValue( 'page_transitions' ),
							...
							<div class="meta">
								...
								<span id="qode_page_id"><?php
									echo esc_attr( bridge_qode_get_page_id() ); ?></span>
								<div class="body_classes"><?php
									echo implode( ',', get_body_class() ); ?></div>
							</div>
						<?php
						} ?>
