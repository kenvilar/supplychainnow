...
if ( have_posts() ): ?>
	...
	while ( have_posts() ):
		...
		<?php
		if ( $single_type == "image-title-post" )://this post type is full width
			?>
			<div class="full_width" <?php
			if ( $background_color != "" ) {
				echo " style='background-color:" . $background_color . "'";
			} ?>>
			<?php
			if (
				isset( $bridge_qode_options["overlapping_content"] )
				&& $bridge_qode_options["overlapping_content"] == "yes"
			) { ?>
