            ...
            <div class="content_inner">
                <div class="full_width">
                    <div class="full_width_inner">
                        <div class="vc_row wpb_row section vc_row-fluid grid_section" style="background-color: #eeeff0; padding-top: 40px; padding-bottom: 40px; text-align: center;">
                                        ...
                                        <div class="vc_column-inner">
                                            <div class="wpb_wrapper">
                                                <div class="wpb_text_column wpb_content_element">
                                                    <div class="wpb_wrapper">
                                                        <h1 class="p2">WEBINAR: <?php echo get_field( "webinar_title" ,$pageId); ?></h1>
                                                    </div>
                                                </div>
											...
											<div class="pic-curved wpb_column vc_column_container vc_col-sm-12" style="padding-bottom: 30px;">
												<div class="vc_column-inner">
													<div class="wpb_wrapper">
														<div class="wpb_single_image wpb_content_element vc_align_center">
															<div class="wpb_wrapper">
																<div class="thum-shadow vc_single_image-wrapper vc_box_border_grey">
																<img src="<?php echo get_the_post_thumbnail_url( get_the_ID(), 'large' ); ?>" class="vc_single_image-img lazyload">				
																																												</div>
															</div>
														</div>
													</div>
											...
											<?php if( !empty(get_field('webinar_button_link',$pageId))){ ?>
											<a itemprop="url" href="<?php echo the_field('webinar_button_link',$pageId); ?>" target="_blank" class="qbutton small default" style="">Click to View this Webinar</a>
											<?php } ?>
						...
						<?php if(!empty(get_field('webinar_description',$pageId))){ ?>
                        <div class="vc_row wpb_row section vc_row-fluid grid_section" style="padding-top: 50px; text-align: left;">
                            <div class="section_inner clearfix">
                                <div class="section_inner_margin clearfix">
                                    <div class="wpb_column vc_column_container vc_col-sm-12">
                                        <div class="vc_column-inner">
                                                ...
                                                <div class="wpb_text_column wpb_content_element custom-font-one">
                                                    <div class="wpb_wrapper">
                                                        <p style="text-align: center;">
                                                            <?php echo get_field( "webinar_description",$pageId ); ?>
                                                        </p>
                                    ...
                                    <div class="wpb_column vc_column_container vc_col-sm-12">
                                        <div class="vc_column-inner">
											...
											?>
												...
												?>
                                                <div class="vc_row wpb_row section vc_row-fluid vc_inner" style="padding-top: 80px; padding-bottom: 40px; text-align: left;">
                                                    <div class="full_section_inner clearfix">
                                                        <div class="wpb_column vc_column_container vc_col-sm-12">
                                                            <div class="vc_column-inner">
                                                                <div class="wpb_wrapper">
            ...
            <div class="vc_column-inner">
                <div class="wpb_wrapper">
                                                    ...
                                                    <div class="q_elements_item_inner">
                                                        <div class="q_elements_item_content q_elements_holder_custom_814542">
                                                            <div class="wpb_text_column wpb_content_element white">
                                                                <div class="wpb_wrapper">
                                                                    <h2 class="text-sm-center">Connect your brand to an active audience of millions</h2>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                    ...
                    <div class="wpb_single_image wpb_content_element vc_align_center styleone-divider-bottom">
                        ...
                        <div class="vc_row wpb_row section vc_row-fluid grid_section" style="padding-top: 50px; padding-bottom: 20px; text-align: left;">
                            <div class="section_inner clearfix">
                                <div class="section_inner_margin clearfix">
                                    <div class="wpb_column vc_column_container vc_col-sm-12">
                                        <div class="vc_column-inner">
